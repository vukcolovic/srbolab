...
export default {
  ...
  data() {
    return {
      certificate: {brand: "", type_vehicle: "", variant: "", version_vehicle: "", commercial_name: "", estimated_production_year: 0, max_mass: 0, running_mass: 0, category: "", bodywork_code: "", axles_tyres_num: "", length: 0, width: 0, height: 0, tyre_wheel: "", engine_code: "", engine_capacity: 0, engine_power: 0, fuel: "", power_weight_ratio: "", seat_number: 0, standing_number: "", max_speed: "", gas_level: "", max_laden_mass_axios: "", number_wvta: "", pollution_cert: "", noise_cert: "", coupling_device_approval: ""},
      users: [],
